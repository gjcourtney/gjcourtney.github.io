function workingGenius() {
  return {
    ...
    teams: ["Everyone", "Core", "Events", "Governance", "Re-org", "Theology"],
    people: [
      new Person(
        "Andrew",
        "McNeil",
        ...
        ["Everyone", "Governance", "Core", "Re-org"]
      ),
      new Person(
        "Andy",
        "Smith",
        "https://cdn.churchsuite.com/Nr6TJr3e/user_files/jlf0pe6t.jpg",
        [
          "Discernment",
          "Wonder",
          "Tenacity",
      ...
      new Person(
        ...
        ["Everyone", "Re-org", "Core"]
      ),
      new Person(
        "James",
        "Rankine",
        "https://images.squarespace-cdn.com/content/v1/6332db237afc5b6bbfaee776/410e151a-7b79-41e9-b936-0210622bcfbd/james.png?format=750w",
        [
          "Galvanising",
          "Invention",
          "Discernment",
      ...
      new Person(
        "Tom",
        "Thompson",
        "https://cdn.churchsuite.com/Nr6TJr3e/user_files/jhmdeuhi.jpg",
        [
          "Discernment",
          "Galvanising",
          "Tenacity",
